...
# -*- coding: utf-8 -*-
"""
Created on Fri Dec  4 04:15:06 2020
...
data=pd.read_csv('/Users/xinxing/Desktop/MDD/New data/MDD_test/MDD_score/MDD_madrs_sum_1.csv').fillna(0)
...
#res_pvalue.to_csv('/Users/xinxing/Desktop/MDD/New data/MDD_test/MDD_score/MDD_madrs_sum_ranking_p.csv') 
...
res_pvalue_1.to_csv('/Users/xinxing/Desktop/MDD/New data/MDD_test/MDD_score/MDD_madrs_sum_ranking_p.csv') 