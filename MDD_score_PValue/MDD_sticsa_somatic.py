...
feature=[ 'sticsa_cognitive']

data=pd.read_csv("/Users/xinxing/Desktop/MDD/New data/MDD_test/MDD_score/MDD_sticsa_somatic.csv")
...
X=df.drop('sticsa_somatic', axis=1)
index=X.columns
index=index.to_list()
index.pop(0)
...
#res_pvalue.to_csv('/Users/xinxing/Desktop/MDD/New data/MDD_test/MDD_score/MDD_sticsa_somatic_ranking_p.csv') 
...
res_pvalue_1.to_csv('/Users/xinxing/Desktop/MDD/New data/MDD_test/MDD_score/MDD_sticsa_somatic_ranking_p.csv')