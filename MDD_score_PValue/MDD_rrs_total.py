...
feature=[
   'shaps_score_1', 'shaps_score_2', 'bss_total', 
                          'sticsa_somatic', 'sticsa_cognitive']

data=pd.read_csv("/Users/xinxing/Desktop/MDD/New data/MDD_test/MDD_score/MDD_rrs_total.csv")
...
#res_pvalue.to_csv('/Users/xinxing/Desktop/MDD/New data/MDD_test/MDD_score/MDD_rrs_total_ranking_p.csv') 
...
res_pvalue_1.to_csv('/Users/xinxing/Desktop/MDD/New data/MDD_test/MDD_score/MDD_rrs_total_ranking_p.csv') 