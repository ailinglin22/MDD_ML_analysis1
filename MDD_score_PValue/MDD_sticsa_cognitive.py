...
data=pd.read_csv("/Users/xinxing/Desktop/MDD/New data/MDD_test/MDD_score/MDD_sticsa_cognitive.csv")

data=data[data.Status==0]
df=data.drop(['Status'],axis=1)


y=df.sticsa_cognitive

X=df.drop('sticsa_cognitive', axis=1)
index=X.columns
index=index.to_list()
index.pop(0)
...
res_pvalue_1.to_csv('/Users/xinxing/Desktop/MDD/New data/MDD_test/MDD_score/MDD_sticsa_cognitive_ranking_p.csv') 