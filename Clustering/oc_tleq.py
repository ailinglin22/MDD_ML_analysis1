...
# -*- coding: utf-8 -*-
"""
Created on Sun Nov 22 14:10:26 2020
...
data=pd.read_csv('/Users/xinxing/Desktop/MDD/New data/MDD_test/MDD_score/MDD_oc_tleq.csv').fillna(0)
...
data=data[['Status',"LGmiddletemporal", "Rinferiortemporal", "RGlateraloccipital","N_Right-Cerebellum-White-Matter",
           "N_WM-hypointensities","N_Right-Cerebellum-Cortex","RGinferiorparietal","LGparacentral","LGmedialorbitofrontal",
           "Lposteriorcingulate","Rfusiform","RGparsorbitalis","RGprecuneus"]] 

index=["LGmiddletemporal", "Rinferiortemporal", "RGlateraloccipital","N_Right-Cerebellum-White-Matter",
           "N_WM-hypointensities","N_Right-Cerebellum-Cortex","RGinferiorparietal","LGparacentral","LGmedialorbitofrontal",
           "Lposteriorcingulate","Rfusiform","RGparsorbitalis","RGprecuneus"]
...
print(("Group 0 avg. score is: ") + str(df_concat[df_concat.label==0]["oc_tleq"].mean()))

print(("Group 1 avg. score is: ") + str(df_concat[df_concat.label==1]["oc_tleq"].mean()))
...
stat_score, p_score = ttest_ind(df_concat[df_concat.label==0].oc_tleq,df_concat[df_concat.label==1].oc_tleq)
