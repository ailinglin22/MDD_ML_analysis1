...
# -*- coding: utf-8 -*-
"""
Created on Sun Nov 22 14:03:52 2020
...
data=pd.read_csv('/Users/xinxing/Desktop/MDD/New data/MDD_test/MDD_score/MDD_lsc_score.csv').fillna(0)
...
df=data[["Age","lsc_score"]] 
df=df.reset_index(drop=True)

'''
data=data[['Status',"RGprecuneus", "LGlateralorbitofrontal","LGisthmuscingulate", "LGparacentral",
           "RGisthmuscingulate", "LGsupramarginal", "RGinferiorparietal", "LGprecuneus",
           "LGposteriorcingulate", "Rparacentral", "RGsuperiorparietal","RGlateralorbitofrontal",
           "Rtemporalpole", "LGpostcentral", "RGprecentral", "RGsuperiorfrontal","LGinsula", "LGmiddletemporal",
           "RGpostcentral", "LGlateraloccipital", "RGrostralanteriorcingulate", "LGprecentral"]] 

index=["RGprecuneus", "LGlateralorbitofrontal","LGisthmuscingulate", "LGparacentral",
           "RGisthmuscingulate", "LGsupramarginal", "RGinferiorparietal", "LGprecuneus",
           "LGposteriorcingulate", "Rparacentral", "RGsuperiorparietal","RGlateralorbitofrontal",
           "Rtemporalpole", "LGpostcentral", "RGprecentral", "RGsuperiorfrontal","Lginsula", "LGmiddletemporal",
           "RGpostcentral", "LGlateraloccipital", "RGrostralanteriorcingulate", "LGprecentral"]
...
data=data[["Status", "LGisthmuscingulate","Rparacentral","Rtemporalpole","RGprecuneus"]]
index=["LGisthmuscingulate","Rparacentral","Rtemporalpole","RGprecuneus"]
...
hierarchy.dendrogram(Z, color_threshold=7.5, above_threshold_color='grey')
 
# Add horizontal line.
plt.axhline(y=7.5, c='black', lw=2, linestyle='dashed')
...
print(("Group 0 avg. score is: ") + str(df_concat[df_concat.label==0]["lsc_score"].mean()))

print(("Group 1 avg. score is: ") + str(df_concat[df_concat.label==1]["lsc_score"].mean()))
from scipy.stats import ttest_ind
stat, p = ttest_ind(df_concat[df_concat.label==0].Age,df_concat[df_concat.label==1].Age)

print("p-value is: "+str(p))

stat_score, p_score = ttest_ind(df_concat[df_concat.label==0].lsc_score,df_concat[df_concat.label==1].lsc_score)
