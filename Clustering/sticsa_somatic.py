...
data=pd.read_csv('/Users/xinxing/Desktop/MDD/New data/MDD_test/MDD_score/MDD_sticsa_somatic.csv').fillna(0)
...
df=data[["Age","sticsa_somatic"]] 
df=df.reset_index(drop=True)

'''
data=data[['Status',"Rprecentral", "RGrostralanteriorcingulate","LGcaudalanteriorcingulate","Rtransversetemporal",
           "Rsupramarginal","Rinsula","N_Left-Inf-Lat-Vent"]] 

index=["Rprecentral", "RGrostralanteriorcingulate","LGcaudalanteriorcingulate","Rtransversetemporal",
           "Rsupramarginal","Rinsula","N_Left-Inf-Lat-Vent"]
'''
...
print(("Group 0 avg. score is: ") + str(df_concat[df_concat.label==0]["sticsa_somatic"].mean()))

print(("Group 1 avg. score is: ") + str(df_concat[df_concat.label==1]["sticsa_somatic"].mean()))
...
stat_score, p_score = ttest_ind(df_concat[df_concat.label==0].sticsa_somatic,df_concat[df_concat.label==1].sticsa_somatic)
