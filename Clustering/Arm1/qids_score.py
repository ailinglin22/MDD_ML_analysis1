...
# -*- coding: utf-8 -*-
"""
Created on Wed May  5 22:12:04 2021
...
for i in range (len(index2)):
    Y1=sm.add_constant(X[[index2[i],"Age","Gender"]])
    est = sm.OLS(y, Y1)
    est2 = est.fit()
    #print(est2.summary())
    p_values = est2.summary2().tables[1]['P>|t|']
...
savepath='/Users/xinxing/Documents/MDD/New data/MDD_test/May_03_2021/MDD_'+item+'_ranking_p_1.csv'
...
# Add horizontal line.
plt.axhline(y=6, c='black', lw=2, linestyle='dashed')
