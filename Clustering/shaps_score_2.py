...
# -*- coding: utf-8 -*-
"""
Created on Sun Nov 22 15:00:31 2020
...
data=pd.read_csv('/Users/xinxing/Desktop/MDD/New data/MDD_test/MDD_score/MDD_shaps_score_2.csv').fillna(0)
...
df=data[["Age","shaps_score_2"]] 
df=df.reset_index(drop=True)


data=data[['Status',"Rlingual","Rprecuneus"]] 

index=["Rlingual","Rprecuneus"]
...
print(("Group 0 avg. score is: ") + str(df_concat[df_concat.label==0]["shaps_score_2"].mean()))

print(("Group 1 avg. score is: ") + str(df_concat[df_concat.label==1]["shaps_score_2"].mean()))
...
stat_score, p_score = ttest_ind(df_concat[df_concat.label==0].shaps_score_2,df_concat[df_concat.label==1].shaps_score_2)
