...
# -*- coding: utf-8 -*-
"""
Created on Sun Nov 22 14:17:28 2020
...
data=pd.read_csv('/Users/xinxing/Desktop/MDD/New data/MDD_test/MDD_score/MDD_pss_score.csv').fillna(0)
...
df=data[["Age","pss_score"]] 
df=df.reset_index(drop=True)
'''
data=data[['Status',"RGlateraloccipital","Rsuperiortemporal","Rtemporalpole","Lparsopercularis","LGtemporalpole",
           "RGlateralorbitofrontal","Linsula","Rinsula","Lfrontalpole",
           "Rparacentral","Lparstriangularis","Rparsopercularis","N_CC_Posterior","Rsupramarginal"]] 

index=["RGlateraloccipital","Rsuperiortemporal","Rtemporalpole","Lparsopercularis","LGtemporalpole",
           "RGlateralorbitofrontal","Linsula","Rinsula","Lfrontalpole",
           "Rparacentral","Lparstriangularis","Rparsopercularis","N_CC_Posterior","Rsupramarginal"]
'''

data=data[["Status", "RGlateraloccipital", "Rsuperiortemporal","Rtemporalpole","Lparsopercularis",
           "LGtemporalpole", "Linsula", "Rinsula","Rparacentral",
           "Lparstriangularis","Rsupramarginal"]]

index=["RGlateraloccipital", "Rsuperiortemporal","Rtemporalpole","Lparsopercularis",
           "LGtemporalpole", "Linsula", "Rinsula","Rparacentral",
           "Lparstriangularis","Rsupramarginal"]
y=data.Status
...
hierarchy.dendrogram(Z, color_threshold=10, above_threshold_color='grey')
 
# Add horizontal line.
plt.axhline(y=10, c='black', lw=2, linestyle='dashed')
...
print(("Group 0 avg. score is: ") + str(df_concat[df_concat.label==0]["pss_score"].mean()))

print(("Group 1 avg. score is: ") + str(df_concat[df_concat.label==1]["pss_score"].mean()))
from scipy.stats import ttest_ind
stat, p = ttest_ind(df_concat[df_concat.label==0].Age,df_concat[df_concat.label==1].Age)

print("p-value is: "+str(p))

stat_score, p_score = ttest_ind(df_concat[df_concat.label==0].pss_score,df_concat[df_concat.label==1].pss_score)
